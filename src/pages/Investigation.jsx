...
export function Protocol({ protocol }) {
  const { state, dispatch, horror } = useGame(); const { t } = useLanguage();
...
export function Archive() {
  const { state, dispatch, horror } = useGame(); const { t } = useLanguage(); const [code, setCode] = useState('');
...
export function Mirror() {
  const { state, dispatch, horror } = useGame(); const { t } = useLanguage(); const [claims, setClaims] = useState([]);
